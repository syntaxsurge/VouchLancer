  ...
  return (
    <section id='cta' className='relative isolate overflow-hidden px-4 py-32 sm:px-6'>
      ...
      <div className='mx-auto max-w-4xl px-4 text-center'>
        ...
        >
          Onboard in One Tap with Civic Auth
        </motion.h2>
        ...
        >
          Skip forms and passwords—authenticate via Civic, receive an embedded wallet, and start
          issuing verifiable proofs instantly.
        </motion.p>
...
function Backdrop() {
  return (
    <div className='pointer-events-none absolute inset-0 -z-10'>
      <div className='animate-slow-pan absolute -inset-20 opacity-60 blur-3xl' />
